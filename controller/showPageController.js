...
module.exports = {
    ...
    async dashboard(req, res) {
        try {
            ...
            res.status(500).clear("token").render('login',{err:"Server error: Cannot load dashboard page."});
        }
    },
    async profile(req, res) {
        try {
            ...
            res.status(500).render('dashboard',{err:"Server error: Cannot load profile page."});
        }
    },
    async edit(req, res) {
        try {
